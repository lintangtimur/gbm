...
(function() {
    ...
    t = this, e = function() {
        ...
        return e.prototype.set_default_values = function() {
            ...
            // return '100% !important'; // By : Warman Suganda 24/04/2014
            var e;
            var ws;//= this.options.width != null ? this.options.width : (e = window.getComputedStyle != null ? parseFloat(window.getComputedStyle(this.form_field).getPropertyValue("width")) : typeof jQuery != "undefined" && jQuery !== null ? this.form_field_jq.outerWidth() : this.form_field.getWidth(), e + "px");
            ws = window.getComputedStyle(this.form_field).getPropertyValue("width");
            // console.log(ws);
            return ws;
