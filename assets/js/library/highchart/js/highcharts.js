...
(function() {
    ...
    var v, C = document,
        ...
        Pb = "stroke-width",
        ya, db, mb, bb, qb, rb, sb, Wa, Xa, Ya, Db, Eb, Fb, Gb, tb, ub, vb, M = {}, B;
    B = K.Highcharts =
    ...
    P.prototype = {
        ...
        applyTextShadow: function(a) {
            var b = this.element,
                ...
                e = {}, f = this.renderer.forExport || b.style.textShadow !== v && !xa;
    ...
    ua.prototype = {
        ...
        buildText: function(a) {
            ...
            !f && !n && !q && e.indexOf(" ") === -1 ? b.appendChild(C.createTextNode(u(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, T && T.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g,
                    ...
                    o(g, function(e) {
                        if (e !== "" || g.length === 1) {
                            var n = {}, x = C.createElementNS(Da, "tspan"),
                                p;
    ...
    ha.prototype = {
        ...
        renderUnsquish: function() {
            var a = this.chart,
                ...
                k = {}, g = b.fontMetrics(e.style.fontSize, d[0] && d[0].label),
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) o(a, function(a, b) {
                ...
                if (n && h > n) {
                    ...
                    for (c = 0; c < h; c++)
                        if (a[c] !== v && (i = {
                            series: e
                        }, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c), l && s(i.name))) m.names[i.x] = i.name; Aa(x[0]) && la(14, !0);
                e.data = [];
                e.options.data = a;
