...
************************************************************************************************************/	
	...
	*/
	...
	function addToArray($id,$name,$parentID,$url="",$target="",$imageIcon="", $js=""){
		if(empty($parentID))$parentID=0;	
			if(empty($imageIcon))$imageIcon="dhtmlgoodies_folder.gif";
		$this->elementArray[$parentID][] = array($id,$name,$url,$target,$imageIcon, $js);
	}
	...
	function drawTree(){
		...
		for($no=0;$no<count($this->elementArray[0]);$no++){
			...
			if($this->elementArray[0][$no][5]){
				$jsInput = $this->elementArray[0][$no][5];
			}
			echo "<li class=\"tree_node\" id=\"node_".$this->elementArray[0][$no][0]."\"><img id=\"plusMinus".$this->elementArray[0][$no][0]."\" class=\"tree_plusminus\" src=\"".$this->folderimage."dhtmlgoodies_plus.gif\"><img src=\"".$this->folderimage.$this->elementArray[0][$no][4]."\"><a ".$jsInput." id=".$this->elementArray[0][$no][0]." class=\"tree_link\"$urlAdd>".$this->elementArray[0][$no][1]."</a>";		
	...
	private function drawSubNode($parentID){
		if(isset($this->elementArray[$parentID])){			
			...
			for($no=0;$no<count($this->elementArray[$parentID]);$no++){
				...
				$jsInput = "";
				if($this->elementArray[$parentID][$no][5]){
					$jsInput = $this->elementArray[$parentID][$no][5];
				}
				echo "<li class=\"tree_node\"><img class=\"tree_plusminus\" id=\"plusMinus".$this->elementArray[$parentID][$no][0]."\" src=\"".$this->folderimage."dhtmlgoodies_plus.gif\"><img src=\"".$this->folderimage.$this->elementArray[$parentID][$no][4]."\"><a ".$jsInput." id=".$this->elementArray[$parentID][$no][0]." class=\"tree_link\"$urlAdd>".$this->elementArray[$parentID][$no][1]."</a>";	
