...
WHERE STATUS_MUTASI_TERIMA IN ('2','6') AND MONTH(TGL_PENGAKUAN) = '$BULAN' AND  YEAR(TGL_PENGAKUAN) = '$TAHUN'
...
WHERE STATUS_MUTASI_PEMAKAIAN IN ('2','6') AND MONTH(TGL_MUTASI_PENGAKUAN) = '$BULAN' AND  YEAR(TGL_MUTASI_PENGAKUAN) = '$TAHUN'
