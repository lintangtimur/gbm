...
WHERE IS_AKTIF_MUTASI_PERSEDIAAN='1' AND MONTH(TGL_MUTASI_PERSEDIAAN) = '$BULAN' AND  YEAR(TGL_MUTASI_PERSEDIAAN) = '$TAHUN')
A 
LEFT OUTER JOIN
(
SELECT SLOC,ID_JNS_BHN_BKR,TGL_PENGAKUAN,SUM(VOL_TERIMA) TERIMA_UNITLAIN FROM MUTASI_PENERIMAAN
WHERE STATUS_MUTASI_TERIMA='2' AND MONTH(TGL_PENGAKUAN) = '$BULAN' AND  YEAR(TGL_PENGAKUAN) = '$TAHUN'
AND JNS_PENERIMAAN='1' GROUP BY SLOC,ID_JNS_BHN_BKR,TGL_PENGAKUAN) PN1 
ON PN1.SLOC = A.SLOC AND PN1.ID_JNS_BHN_BKR=A.ID_JNS_BHN_BKR AND PN1.TGL_PENGAKUAN=A.TGL_MUTASI_PERSEDIAAN
LEFT OUTER JOIN
(
SELECT SLOC,ID_JNS_BHN_BKR,TGL_PENGAKUAN,SUM(VOL_TERIMA) TERIMA_PEMASOK FROM MUTASI_PENERIMAAN
WHERE STATUS_MUTASI_TERIMA='2' AND MONTH(TGL_PENGAKUAN) = '$BULAN' AND  YEAR(TGL_PENGAKUAN) = '$TAHUN'
AND JNS_PENERIMAAN='2' GROUP BY SLOC,ID_JNS_BHN_BKR,TGL_PENGAKUAN) PN2
...
WHERE STATUS_MUTASI_PEMAKAIAN='2' AND MONTH(TGL_MUTASI_PENGAKUAN) = '$BULAN' AND  YEAR(TGL_MUTASI_PENGAKUAN) = '$TAHUN'
AND JENIS_PEMAKAIAN='1' GROUP BY SLOC,ID_JNS_BHN_BKR,TGL_MUTASI_PENGAKUAN) PK1
...
WHERE STATUS_MUTASI_PEMAKAIAN='2' AND MONTH(TGL_MUTASI_PENGAKUAN) = '$BULAN' AND  YEAR(TGL_MUTASI_PENGAKUAN) = '$TAHUN'
AND JENIS_PEMAKAIAN='2' GROUP BY SLOC,ID_JNS_BHN_BKR,TGL_MUTASI_PENGAKUAN) PK2
