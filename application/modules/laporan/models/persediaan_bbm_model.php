...
class persediaan_bbm_model extends CI_Model {
    ...
    public function getData_Model($data)
    {
        ...
        $sql = "SELECT F.NAMA_REGIONAL LEVEL0, E.LEVEL1,D.LEVEL2,C.LEVEL3,B.LEVEL4,G.NAMA_JNS_BHN_BKR,
				...
				pemakaian_sendiri(A.SLOC, A.ID_JNS_BHN_BKR, DATE_FORMAT(TGL_MUTASI_PERSEDIAAN, '%d%m%Y')) PEMAKAIAN_SENDIRI, 
                pemakaian_unitlain(A.SLOC, A.ID_JNS_BHN_BKR, DATE_FORMAT(TGL_MUTASI_PERSEDIAAN, '%d%m%Y')) PEMAKAIAN_KIRIM,
