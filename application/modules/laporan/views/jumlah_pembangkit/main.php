...
<form id="export_pdf" action="<?php echo base_url('laporan/jumlah_pembangkit/export_pdf'); ?>" method="post" >
...
<form id="export_pdf_detail" action="<?php echo base_url('laporan/jumlah_pembangkit/export_pdf_detail'); ?>" method="post" >
    <input type="hidden" name="plvl0">
    <input type="hidden" name="plvl1">
    <input type="hidden" name="plvl2">
    <input type="hidden" name="plvl3">
   ...
   function setCekTgl(){
    ...
    $('#button-load').click(function(e) {
        ...
        // }
            ...
            //   tglAkhir = '-';
            // }
            // console.log(' regional: '+ lvl0+' vlevlid: ' + vlevelid+' TglAwal: '+ tglAwal+ ' TglAkhir: '+tglAkhir);
            console.log(' regional: '+ lvl0+' vlevlid: ' + vlevelid);
            bootbox.dialog('<div class="loading-progress" style="color:#ac193d;"></div>');
                $.ajax({
                    type: "POST",
    ...
    $('#button-excel').click(function(e) {
      ...
      // var thn = $('#thn').val(); //tahun dropdown
        ...
        if (lvl0 == '') {
          ...
          console.log("Vlevelid: "+vlevelid+"Regional:"+lvl0);
