...
<table class="tdetail">
    ...
    <tr>
      ...
      ?>
        ...
        <td style="text-align:center;"><?php echo $NAMA_PEMASOK ?></td>
        <td style="text-align:center;"><?php echo $NAMA_TRANSPORTIR ?></td>
        <td style="text-align:right;"><?php echo $TGL_DO ?></td>
        <td style="text-align:right;"><?php echo $TGL_TERIMA_FISIK ?></td>
