...
<script type="text/javascript">
   ...
   function setCekTgl(){
        // var dateStart = new Date($('#tglawal').val());
        // var dateEnd = new Date($('#tglakhir').val());
  ...
  $('#button-detail').addClass('disabled');
    ...
    $('#dataTable tbody').on( 'click', 'button', function () {
      ...
      bootbox.dialog('<div class="loading-progress" style="color:#ac193d;"></div>');
        ...
        var halaman = parseInt($('input[name="halaman_detail"]').val());
        // var baris = getValueLengthMenu('dataTable_detail');
        // var baris = $('input[name="menu_detail"]').val();
        var baris = getMenuData();

        // var halaman = getCurrentPage('dataTable_detail'); //1
        // console.log("idBBM: "+id_bbm+"detail_tgl_awal:"+parsed_tglawal+" tglakhir: "+parsed_tglakhir+" kd: "+kode_unit);
        var tdetail = $('#dataTable_detail').DataTable({
          ...
          //   "type": 'POST',
          //   "data": function(data){
          //     data.detail_id_bbm = id_bbm;
          //     data.detail_tgl_awal= parsed_tglawal;
          //     data.detail_tgl_akhir=parsed_tglakhir;
          //     data.detail_kode_unit = kode_unit;
          //     data.detail_jumlah_terima= jumlah_terima;
          //     // "halaman":'1'
          //   },
          // },
          ...
          //       .on('click', function(){
          //           // $('input[name="halaman_detail"]').val(halaman+=1);
          //           console.log(baris);
          //          getPageData(halaman+=1,id_bbm, parsed_tglawal, parsed_tglakhir, kode_unit);
          //       });
        ...
        // console.log("TglAwal: "+tglAwal+" TglAkhir: "+tglAkhir+" KodeUNIT: "+kode_unit+" ID_BBM: "+id_bbm);
        console.log("TglAwal: "+parsed_tglawal+" TglAkhir: "+parsed_tglakhir+" KodeUNIT: "+kode_unit+" ID_BBM: "+id_bbm);
                        ...
                        if (obj == "" || obj == null) {
                         ...
                         $.each(obj, function (index, value) {
                            ...
                            t.row.add( [
                                ...
                                TGL_TERIMA_AKHIR, JML_TERIMA, convertToRupiah(VOL_TOTAL_TERIMA),
    ...
    $('#button-pdf').click(function(e) {
        ...
        if (lvl0 == '') {
          ...
          if (bbm == '') {
            ...
            console.log("PDF tglawal: "+awalParsed + "tglaakhir: "+akhirParsed+"bbm: "+bbm+" vlevlid: "+vlevelid);
