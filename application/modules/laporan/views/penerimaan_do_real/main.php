...
<div class="inner_content">
    <div class="statistic clearfix">
        <div class="current_page pull-left">
            <span><?php echo isset($page_title) ? $page_title : 'Laporan Penerimaan DO vs REAL BBM'; ?></span>
        </div>
    </div>
          ...
          tooltips: {
            ...
            callbacks: {
                label: function(tooltipItem, data) {
                    return  convertToRupiah(tooltipItem.yLabel.toString());
                }
            }
        }
      }
