    ...
    ?>
       ...
       <!-- <div class="controls" id="dokumen">
        ...
        <div class="control-group">
            ...
            <div class="controls">
            <?php echo form_input('JML_PASOKAN', !empty($default->JML_PASOKAN) ? $default->JML_PASOKAN : '', 'class="span2", id="JML_PASOKAN", placeholder="Max 20" disabled'); ?>
        </div>
        </div>
        <br>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#addButton").click(function () {
            ...
            var text_jarak="<input type='text' id='jarak_ke"+ counter + "' name='jarak_ke"+ counter + "' placeholder='Jarak (KM atau ML)' size='37' disabled>";
