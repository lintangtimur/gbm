...
$("#addButton").click(function () {
    ...
    var combo_depo ="<select class='form-control' id='depo_ke"+ counter + "'disabled>"+
    ...
    var combo_pembangkit ="<select class='form-control' id='pembangkit_ke"+ counter + "'disabled>"+
    ...
    var combo_jalur ="<select class='form-control' id='jalur_ke"+ counter + "'disabled>"+
