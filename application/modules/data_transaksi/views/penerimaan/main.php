                ...
                for (i = 0; i < data_detail.length; i++) {
                    ...
                    if (user_level==3 || user_level==4 ){
                        edit = '<td align="center">' +
                            '<a href="javascript:void(0);" class="btn transparant" id="button-edit-003" onclick="load_form(this.id)" data-source="<?php echo base_url()?>data_transaksi/penerimaan/edit/'+data_detail[i].ID_PENERIMAAN +'"><i class="icon-edit"></i></a>'+
                            '</a></td>';
                    }
